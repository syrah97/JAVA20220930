...
public class C02PercentArith {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		/*
		// 세 정수를 받아서 세수의 합이 5의 배수인 경우 
		// 5의배수입니다 를 출력 
		//아닌 경우 5의배수가 아닙니다 를 출력 Scanner
		sc = new Scanner(System.in); 
		int n1,n2,n3,sum; n1=sc.nextInt();
		n2=sc.nextInt(); n3=sc.nextInt(); sum=n1+n2+n3;
...
//		}
		...
		//정수 하나를 입력받아 거꾸로 저장해보세요(반복문법 이후 풀어보기)%,/연상 동시이용할 것
		//예
